 ...
 *
 */
public class WebMapperImpl extends BasicMapper{

	public static final Logger LOGGER=Logger.getLogger(WebMapperImpl.class);

    public WebMapperImpl(List<Object> properties){
